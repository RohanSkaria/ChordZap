import { BaseScraper, ScrapingResult, ScrapingOptions, TabData, SongInfo, ChordInfo, TabSection } from '../scraping/BaseScraper';
...
export class UltimateGuitarScraper extends BaseScraper {
  ...
  constructor() {
    super('Ultimate Guitar', 'https://www.ultimate-guitar.com', 20);
  }
  ...
  private async performGetTab(id: string): Promise<ScrapingResult> {
    // todo: need actual scraping logic here
